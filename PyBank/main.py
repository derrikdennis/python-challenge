...
with open(output, "w+") as file:
    ...
    file.write("Average Revenue Change: " +
               '${:,.2f}'.format(averageProfitLossChange)+"\n")
    file.write("Greatest Increase in Profits: " + str(maxProfitLossMonth) +
               " " + '${:,.2f}'.format(maxProfitLossChange)+"\n")
    file.write("Greatest Decrease in Profits: " + str(minProfitLossMonth) +
               " " + '${:,.2f}'.format(minProfitLossChange)+"\n")
